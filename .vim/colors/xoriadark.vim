...
let colors_name = "xoriadark"
"}}}
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=232 guibg=#080808 cterm=none gui=none
...
"hi Comment      ctermfg=10  guifg=#00ff00   
...
"" Special {{{2
""" Easymotion {{{3
hi EasyMotionTarget ctermbg=none ctermfg=14 guifg=#00ffff cterm=bold gui=bold
hi EasyMotionShade  ctermbg=none ctermfg=239 guifg=#4e4e4e
""" .diff {{{3
